...
{
    iot_server_type_t server_type;
    UNUSED(state);

    // Test known server URLs - all should return correct server types
    server_type = iot_util_get_server_type("mqtt-regional-apnortheast2.api.smartthings.com");
    assert_int_equal(server_type, IOT_SERVER_PROD_AP_NORTH_EAST2);

    server_type = iot_util_get_server_type("mqtt-regional-useast1.api.smartthings.com");
    assert_int_equal(server_type, IOT_SERVER_PROD_US_EAST1);

    server_type = iot_util_get_server_type("mqtt-regional-euwest1.api.smartthings.com");
    assert_int_equal(server_type, IOT_SERVER_PROD_EU_WEST1);

    server_type = iot_util_get_server_type("mqtt-regional-cnnorth1.samsungiotcloud.cn");
    assert_int_equal(server_type, IOT_SERVER_PROD_CHINA);

    server_type = iot_util_get_server_type("mqtt-acceptance-useast2.stacceptance.com");
    assert_int_equal(server_type, IOT_SERVER_ACC_US_EAST2);

    server_type = iot_util_get_server_type("mqtt-staging-useast1.smartthingsgdev.com");
    assert_int_equal(server_type, IOT_SERVER_STG_US_EAST1);

    server_type = iot_util_get_server_type("mqtt-staging-cnnorth1.samsungiots.cn");
    assert_int_equal(server_type, IOT_SERVER_STG_CHINA);

    server_type = iot_util_get_server_type("mqtt-dev-useast1.smartthingsgdev.com");
    assert_int_equal(server_type, IOT_SERVER_DEV_US_EAST1);
}
...
void TC_iot_util_get_server_type_null_url(void **state)
{
    ...
    // When: NULL server URL
    server_type = iot_util_get_server_type(NULL);
    // Then: should return UNKNOWN
    assert_int_equal(server_type, IOT_SERVER_UNKNOWN);
}
...
void TC_iot_util_get_server_type_empty_url(void **state)
{
    ...
    // When: empty server URL
    server_type = iot_util_get_server_type("");
    // Then: should return UNKNOWN
    assert_int_equal(server_type, IOT_SERVER_UNKNOWN);
}
...
void TC_iot_util_get_server_type_unknown_domain(void **state)
{
    ...
    // When: unknown server URL
    server_type = iot_util_get_server_type("unknown.server.com");
    // Then: should return UNKNOWN
    assert_int_equal(server_type, IOT_SERVER_UNKNOWN);
}
...
void TC_iot_util_get_server_type_partial_url(void **state)
{
    ...
    // When: partial server URL
    server_type = iot_util_get_server_type("mqtt-regional");
    // Then: should return UNKNOWN
    assert_int_equal(server_type, IOT_SERVER_UNKNOWN);
}
...
void TC_iot_util_get_server_type_wrong_domain(void **state)
{
    ...
    // When: server URL with wrong domain
    server_type = iot_util_get_server_type("mqtt-regional-useast1.wrongdomain.com");
    // Then: should return UNKNOWN
    assert_int_equal(server_type, IOT_SERVER_UNKNOWN);
}
