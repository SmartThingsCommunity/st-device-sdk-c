...
int TEST_FUNC_iot_api(void)
{
    const struct CMUnitTest tests[] = {
            ...
            cmocka_unit_test_setup_teardown(TC_iot_wifi_get_status_success, TC_iot_api_memleak_detect_setup, TC_iot_api_memleak_detect_teardown),
            cmocka_unit_test_setup_teardown(TC_iot_state_timeout_change_failure, TC_iot_api_memleak_detect_setup, TC_iot_api_memleak_detect_teardown),
            cmocka_unit_test_setup_teardown(TC_iot_state_timeout_change_success, TC_iot_api_memleak_detect_setup, TC_iot_api_memleak_detect_teardown),
            cmocka_unit_test_setup_teardown(TC_iot_misc_info_load_failure, TC_iot_misc_info_dip_setup, TC_iot_misc_info_dip_teardown),
            cmocka_unit_test(TC_iot_set_st_ecode_invalid_parameters),
            cmocka_unit_test_setup_teardown(TC_iot_set_st_ecode_success, TC_iot_misc_info_dip_setup, TC_iot_misc_info_dip_teardown),
            cmocka_unit_test_setup_teardown(TC_iot_set_st_ecode_from_conn_error_success, TC_iot_misc_info_dip_setup, TC_iot_misc_info_dip_teardown),
            cmocka_unit_test_setup_teardown(TC_iot_get_st_ecode_null_parameter, TC_iot_api_memleak_detect_setup, TC_iot_api_memleak_detect_teardown),
            cmocka_unit_test_setup_teardown(TC_iot_get_st_ecode_success, TC_iot_api_memleak_detect_setup, TC_iot_api_memleak_detect_teardown),
            cmocka_unit_test_setup_teardown(TC_iot_wifi_ctrl_request_IOT_WIFI_MODE_STATION, TC_iot_api_memleak_detect_setup, TC_iot_api_memleak_detect_teardown),
            cmocka_unit_test_setup_teardown(TC_iot_wifi_ctrl_request_failure, TC_iot_api_memleak_detect_setup, TC_iot_api_memleak_detect_teardown),
            cmocka_unit_test_setup_teardown(TC_iot_wifi_ctrl_request_IOT_WIFI_MODE_SOFTAP, TC_iot_easysetup_common_setup, TC_iot_easysetup_common_teardown),
            cmocka_unit_test_setup_teardown(TC_iot_cleanup_success, TC_iot_easysetup_common_setup, TC_iot_easysetup_common_teardown),
    };
