...
{
	return MQTTPacket_len(MQTTSerialize_publishLength(qos, topicName, payloadlen));
}

int MQTTSerialize_publish_header(unsigned char* buf, unsigned char dup, int qos, unsigned char retained, unsigned short packetid,
