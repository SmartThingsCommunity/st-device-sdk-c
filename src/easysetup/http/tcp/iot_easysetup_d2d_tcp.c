...
STATIC_FUNCTION
iot_error_t _encrypt_and_encode(iot_security_context_t *security_context, unsigned char *plain_msg,
                                size_t plain_msg_len, char **out_msg)
{
    iot_error_t err;
    ...
    err = iot_security_base64_encode_urlsafe(encrypt_buf.p, encrypt_buf.len, encrypt_b64url_buf.p,
                                             encrypt_b64url_buf.len, &out_len);
    if (err != IOT_ERROR_NONE) {
...
STATIC_FUNCTION
iot_error_t _decode_and_decrypt(iot_security_context_t *security_context, unsigned char *encrypt_b64url_msg,
                                size_t encrypt_b64url_msg_len, char **out_msg)
{
    iot_error_t err;
    ...
    err = iot_security_base64_decode_urlsafe(encrypt_b64url_msg, encrypt_b64url_msg_len, decrypt_buf.p, decrypt_buf.len,
                                             &decoded_len);
    if (err != IOT_ERROR_NONE) {
