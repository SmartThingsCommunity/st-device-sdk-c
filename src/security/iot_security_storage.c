...
iot_error_t iot_security_storage_init(iot_security_context_t *context)
{
    ...
    if (context->be_context && context->be_context->fn && context->be_context->fn->storage_init) {
...
iot_error_t iot_security_storage_deinit(iot_security_context_t *context)
{
    ...
    if (context->be_context && context->be_context->fn && context->be_context->fn->storage_deinit) {
