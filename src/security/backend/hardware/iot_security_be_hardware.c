...
STATIC_FUNCTION
iot_error_t _iot_security_be_hardware_pk_get_key_type(iot_security_context_t *context,
...
STATIC_FUNCTION
iot_error_t _iot_security_be_hardware_pk_set_sign_type(iot_security_context_t *context,
...
STATIC_FUNCTION
iot_error_t _iot_security_be_hardware_pk_sign(iot_security_context_t *context, iot_security_buffer_t *input_buf,
...
STATIC_FUNCTION
iot_error_t _iot_security_be_hardware_pk_verify(iot_security_context_t *context, iot_security_buffer_t *input_buf,
                                                iot_security_buffer_t *sig_buf)
{
    iot_error_t err;
...
STATIC_FUNCTION
iot_error_t _iot_security_be_hardware_manager_generate_key(iot_security_context_t *context,
...
STATIC_FUNCTION
iot_error_t _iot_security_be_hardware_manager_set_key(iot_security_context_t *context,
...
STATIC_FUNCTION
iot_error_t _iot_security_be_hardware_manager_get_key(iot_security_context_t *context, iot_security_key_id_t key_id,
...
STATIC_FUNCTION
iot_error_t _iot_security_be_hardware_manager_get_certificate(iot_security_context_t *context,
...
STATIC_FUNCTION
iot_error_t _iot_security_be_hardware_cipher_set_params(iot_security_context_t *context,
...
STATIC_FUNCTION
iot_error_t _iot_security_be_software_cipher_aes_check_info(iot_security_cipher_params_t *cipher_params,
...
STATIC_FUNCTION
iot_error_t _iot_security_be_software_cipher_aes(iot_security_context_t *context,
                                                 iot_security_cipher_mode_t cipher_mode,
                                                 iot_security_buffer_t *input_buf, iot_security_buffer_t *output_buf)
{
    iot_error_t err;
    iot_security_cipher_params_t *cipher_params;
    const mbedtls_cipher_info_t *mbed_cipher_info;
...
STATIC_FUNCTION
iot_error_t _iot_security_be_hardware_cipher_aes_encrypt(iot_security_context_t *context,
...
STATIC_FUNCTION
iot_error_t _iot_security_be_hardware_cipher_aes_decrypt(iot_security_context_t *context,
                                                         iot_security_buffer_t *input_buf,
                                                         iot_security_buffer_t *output_buf)
{
...
STATIC_FUNCTION
iot_error_t _iot_security_be_hardware_ecdh_set_params(iot_security_context_t *context,
...
STATIC_FUNCTION
iot_error_t _iot_security_be_hardware_ecdh_compute_shared_secret(iot_security_context_t *context,
                                                                 iot_security_buffer_t *output_buf)
{
    iot_error_t err;
    iot_security_ecdh_params_t *ecdh_params;
