...
STATIC_FUNCTION
iot_error_t _iot_security_be_bsp_fs_storage_id2filename(iot_security_storage_id_t storage_id, char *filename,
                                                        size_t filename_len)
{
...
STATIC_FUNCTION
iot_error_t _iot_security_be_bsp_fs_load_from_nv(iot_security_storage_id_t storage_id,
...
STATIC_FUNCTION
iot_error_t _iot_security_be_bsp_fs_load(iot_security_be_context_t *be_context, iot_security_storage_id_t storage_id,
                                         iot_security_buffer_t *output_buf)
{
...
STATIC_FUNCTION
iot_error_t _iot_security_be_bsp_fs_store(iot_security_be_context_t *be_context, iot_security_storage_id_t storage_id,
