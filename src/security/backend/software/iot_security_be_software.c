...
STATIC_FUNCTION
iot_error_t _iot_security_be_check_context_and_params_is_valid(iot_security_context_t *context,
...
STATIC_FUNCTION
iot_error_t _iot_security_be_software_bsp_fs_load(iot_security_context_t *context, iot_security_storage_id_t storage_id,
...
STATIC_FUNCTION
iot_error_t _iot_security_be_software_pk_load_ed25519_key(iot_security_context_t *context, iot_security_key_id_t key_id,
                                                          iot_security_buffer_t *output_buf)
{
    iot_error_t err;
    iot_security_storage_id_t storage_id;
...
STATIC_FUNCTION
iot_error_t _iot_security_be_software_pk_get_key_type(iot_security_context_t *context,
...
#if defined(CONFIG_STDK_IOT_CORE_CRYPTO_SUPPORT_ECDSA)
STATIC_FUNCTION
iot_error_t _iot_security_be_software_pk_set_sign_type(iot_security_context_t *context,
                                                       iot_security_pk_sign_type_t pk_sign_type)
{
    iot_error_t err;
...
STATIC_FUNCTION
iot_error_t _iot_security_be_software_pk_sign(iot_security_context_t *context, iot_security_buffer_t *input_buf,
...
#if defined(CONFIG_STDK_IOT_CORE_CRYPTO_SUPPORT_VERIFY)
STATIC_FUNCTION
iot_error_t _iot_security_be_software_pk_verify(iot_security_context_t *context, iot_security_buffer_t *input_buf,
                                                iot_security_buffer_t *sig_buf)
{
    iot_error_t err;
...
STATIC_FUNCTION
iot_error_t _iot_security_be_software_cipher_set_params(iot_security_context_t *context,
...
STATIC_FUNCTION
iot_error_t _iot_security_be_software_cipher_aes_encrypt(iot_security_context_t *context,
...
STATIC_FUNCTION
iot_error_t _iot_security_be_software_cipher_aes_decrypt(iot_security_context_t *context,
                                                         iot_security_buffer_t *input_buf,
                                                         iot_security_buffer_t *output_buf)
{
    iot_error_t err = IOT_ERROR_NONE;
...
STATIC_FUNCTION
iot_error_t _iot_security_be_software_manager_generate_key(iot_security_context_t *context,
                                                           iot_security_key_id_t key_id)
{
...
STATIC_FUNCTION
iot_error_t _iot_security_be_software_manager_set_key(iot_security_context_t *context,
...
STATIC_FUNCTION
iot_error_t _iot_security_be_software_manager_get_key(iot_security_context_t *context, iot_security_key_id_t key_id,
...
STATIC_FUNCTION
iot_error_t _iot_security_be_software_manager_get_certificate(iot_security_context_t *context,
                                                              iot_security_cert_id_t cert_id,
...
STATIC_FUNCTION
iot_error_t _iot_security_be_software_ecdh_set_params(iot_security_context_t *context,
...
STATIC_FUNCTION
iot_error_t _iot_security_be_software_ecdh_compute_shared_secret(iot_security_context_t *context,
                                                                 iot_security_buffer_t *output_buf)
{
    iot_error_t err;
    iot_security_ecdh_params_t *ecdh_params;
    ...
    switch (ecdh_params->key_id) {
        case IOT_SECURITY_KEY_ID_EPHEMERAL:
            ...
            if (ecdh_params->t_seckey.p) {
                err = port_crypto_compute_ecdh_shared(IOT_SECURITY_KEY_TYPE_ECCP256, &ecdh_params->t_seckey,
                                                      &ecdh_params->c_pubkey, &pmsecret_buf);
            } else
#endif
            {
                ...
                err = port_crypto_compute_ecdh_shared(IOT_SECURITY_KEY_TYPE_ECCP256, &ephemeral_seckey_buf,
                                                      &ecdh_params->c_pubkey, &pmsecret_buf);
                if (err) {
                    IOT_DUMP(IOT_DEBUG_LEVEL_ERROR, err, __LINE__, 0);
                    goto exit;
            ...
            break;
        default:
            err = port_crypto_compute_ecdh_shared(IOT_SECURITY_KEY_TYPE_ED25519, &ecdh_params->t_seckey,
                                                  &ecdh_params->c_pubkey, &pmsecret_buf);
            if (err) {
                IOT_DUMP(IOT_DEBUG_LEVEL_ERROR, err, __LINE__, 0);
                goto exit;
...
iot_error_t _iot_security_be_software_storage_write(iot_security_context_t *context, iot_security_buffer_t *data_buf)
{
    ...
    if (!context->be_context->bsp_fn || !context->be_context->bsp_fn->bsp_fs_store) {
...
iot_error_t _iot_security_be_software_storage_remove(iot_security_context_t *context)
{
    ...
    if (!context->be_context->bsp_fn || !context->be_context->bsp_fn->bsp_fs_remove) {
