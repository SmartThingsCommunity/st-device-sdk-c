...
iot_error_t iot_security_pk_init(iot_security_context_t *context)
{
    ...
    if (context->be_context && context->be_context->fn && context->be_context->fn->pk_init) {
...
iot_error_t iot_security_pk_deinit(iot_security_context_t *context)
{
    ...
    if (context->be_context && context->be_context->fn && context->be_context->fn->pk_deinit) {
...
iot_error_t iot_security_cipher_init(iot_security_context_t *context)
{
    ...
    if (context->be_context && context->be_context->fn && context->be_context->fn->cipher_init) {
...
iot_error_t iot_security_cipher_deinit(iot_security_context_t *context)
{
    ...
    if (context->be_context && context->be_context->fn && context->be_context->fn->cipher_deinit) {
