...
iot_error_t iot_security_ecdh_init(iot_security_context_t *context)
{
    ...
    if (context->be_context && context->be_context->fn && context->be_context->fn->ecdh_init) {
...
iot_error_t iot_security_ecdh_deinit(iot_security_context_t *context)
{
    ...
    if (context->be_context && context->be_context->fn && context->be_context->fn->ecdh_deinit) {
