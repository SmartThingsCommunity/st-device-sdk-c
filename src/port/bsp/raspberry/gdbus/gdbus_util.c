                           ...
                           GVariant **reply)
{
    ...
    *reply = g_dbus_connection_call_sync(get_gdbus_connection(), service, object_path, iface, method, parameter, NULL,
                            ...
                            GAsyncReadyCallback asyncCB, gpointer cdData)
{
    ...
    g_dbus_connection_call(get_gdbus_connection(), service, object_path, iface, method, parameter, NULL,
                           G_DBUS_CALL_FLAGS_NONE, timeout_msec, NULL, (GAsyncReadyCallback)asyncCB, cdData);
...
guint gdbus_register_object(const char *path, const gchar *xml, GDBusInterfaceVTable vtable)
{
    ...
    registration_id = g_dbus_connection_register_object(get_gdbus_connection(), path, introspection_data->interfaces[0],
                                                        &vtable, NULL, /* user_data */
