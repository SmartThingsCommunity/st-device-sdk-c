...
#define IOT_USR_INTERACT_BIT_ALL	(IOT_USR_INTERACT_BIT_PROV_CONFIRM | IOT_USR_INTERACT_BIT_STATE_UNKNOWN \
				| IOT_USR_INTERACT_BIT_PROV_DONE | IOT_USR_INTERACT_BIT_CLEANUP_DONE | IOT_USR_INTERACT_BIT_CMD_DONE)
