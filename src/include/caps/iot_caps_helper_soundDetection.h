...
const static struct iot_caps_soundDetection {
    ...
    const struct soundDetection_cmd_enableSoundDetection { const char* name; } cmd_enableSoundDetection;
    const struct soundDetection_cmd_disableSoundDetection { const char* name; } cmd_disableSoundDetection;
    ...
    .attr_soundDetected = {
        ...
        .values = {"noSound", "babyCrying", "glassBreaking", "fireAlarm", "applianceAlarm", "emergencyAlarm", "screaming", "dogBarking", "dogGrowling", "dogHowling", "catMeowing", "catPurring", "doorKnocking", "doorbell", "faucetRunning", "hairDrying", "kettleBoiling", "siren", "fingerSnapping", "clapping", "coughing", "speech", "snoring"},
