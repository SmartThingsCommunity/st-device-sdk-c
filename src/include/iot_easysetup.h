...
#define IOT_ERROR_EASYSETUP_REQUEST_PENDING                 (IOT_ERROR_EASYSETUP_400_BASE - 10)
...
#define IOT_ERROR_EASYSETUP_PUBLIC_KEY_GET_FAIL             (IOT_ERROR_EASYSETUP_500_BASE - 17)
...
/**
 * @brief   Handle offline diagnostics wifi update command
 * @details Complete offline diagnostics wifi update response
 * @param[in]   ctx     iot_context
 * @param[in]   param   device work parameter
 */
